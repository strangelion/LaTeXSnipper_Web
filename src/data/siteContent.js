...
export const FALLBACK_RELEASE = {
  ...
  publishedAt: "",
  releaseNotesUrl:
    "https://github.com/SakuraMathcraft/LaTeXSnipper/releases/tag/v3.0.0-LTS",
};

export const trustItems = [
  {
    title: "本地优先",
    description: "MathCraft OCR 与数学计算可在本机运行",
  },
  {
    title: "公式、文字与混合识别",
    description: "针对公式、纯文字和图文页面提供独立模式",
  },
  {
    title: "20 种导出格式",
    description: "12 种内置格式与 8 种可选 Pandoc 格式",
  },
  {
    title: "桌面多平台",
    description: "Windows 为主要平台，Linux 与 macOS 通过 Provider 层支持",
  },
];
...
export const workflowSteps = [
  {
    number: "01",
    title: "捕获",
    description: "使用截图快捷键、图片、PDF 或手写画布输入内容。",
  },
  {
    number: "02",
    title: "识别",
    description: "选择公式、文字、混合 MathCraft OCR，或已配置的外部模型。",
  },
  {
    number: "03",
    title: "编辑与计算",
    description: "在 MathLive 编辑器中修正结果，并进行计算、化简、展开或求解。",
  },
  {
    number: "04",
    title: "导出与插入",
...
export const featureShowcases = [
  ...
  },
  {
    ...
    href: "https://github.com/SakuraMathcraft/LaTeXSnipper/blob/main/office_plugin/README.md",
    cta: "查看 Office 插件说明",
  },
];
...
export const recognitionDemos = [
  {
    ...
    tagline: "从屏幕像素到数学结构",
    description:
      "截取屏幕中的任意区域，识别环境从像素中提取公式与文字结构，结果回到同一个工作空间继续编辑。",
    image: "/assets/demos/screenshot-recognition.webp",
    poster: "/assets/demos/screenshot-recognition-poster.jpg",
  },
  {
    id: "image",
    label: "IMAGE",
    ...
    tagline: "教材、论文与手写页",
    description:
      "把已有的教材页、论文图片或照片载入识别环境，将公式与文字转换为可编辑、可导出的数学内容。",
    image: "/assets/demos/image-recognition.webp",
    poster: "/assets/demos/image-recognition-poster.jpg",
  },
  {
    id: "pdf",
    label: "PDF",
    ...
    tagline: "按页进入识别流程",
    description:
      "打开 PDF 文档后逐页识别，数学内容随版面顺序进入识别结果，供检查、复制或导出使用。",
    image: "/assets/demos/pdf-recognition.webp",
    poster: "/assets/demos/pdf-recognition-poster.jpg",
  },
];
...
export const desktopPlatforms = [
  {
    name: "Windows",
    status: "主要发布平台",
    capability: "原生全局快捷键、Qt 截图、桌面安装包",
    requirement: "Windows 10 / 11",
  },
  {
    name: "Linux",
    status: "Provider 层支持",
    capability: "pynput 快捷键、Qt 截图、Wayland/X11/portal 回退",
    requirement: "Python >=3.10,<3.13，venv/pip 可用",
  },
  {
    name: "macOS",
    status: "Provider 层支持",
    capability: "原生快捷键、Qt 截图、screencapture 回退",
    requirement: "Python >=3.10,<3.13；截图需屏幕录制权限",
  },
];
...
export const officePlatforms = [
  {
    ...
    status: "已发布",
    insert: "OLE、原生 OMML",
    manage: "加载、更新、删除、编号、引用、OLE/OMML 转换",
    requirement: "Windows Office 2019/2021/2024/LTSC/Microsoft 365；32/64 位",
  },
  {
    host: "Microsoft PowerPoint",
    status: "已发布",
    insert: "OLE、PNG",
    manage: "加载、更新、删除、OLE/PNG 转换、保留缩放",
    requirement: "Windows Office 2019/2021/2024/LTSC/Microsoft 365；32/64 位",
  },
];
