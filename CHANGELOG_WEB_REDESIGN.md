# Web redesign changelog

## 2026-07-19

- Established the audited Worker Static Assets deployment model in project docs.
- Added the release manifest as the download center's source of truth.
- Reframed the home page around the local-first mathematical workspace, real
  product imagery, and clearly separated ecosystem projects.
...
- Removed the retired website Office.js taskpane, manifests, static output, and routes.
- Kept browser OCR, Core WASM, Desktop VSTO documentation, R2/KV routing, and the
  release lock intact.
